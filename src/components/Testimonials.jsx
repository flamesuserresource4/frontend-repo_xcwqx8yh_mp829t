  ...
  return (
    <section id="reviews" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <h2 className="text-3xl md:text-4xl font-bold text-rose-950">Отзывы пациентов</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
          {data.map((t, i) => (
            <motion.div
              ...
              className="rounded-2xl p-6 ring-1 ring-slate-200 bg-white shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition"
            >
